...
namespace KingSurvivalGame
{
    public class KingSurvival
    {
        ...
        {   
            ...
            figures.Add(new Pawn(new Position(4, 0), 'A')); //2,4
            figures.Add(new Pawn(new Position(5, 2), 'B')); //2,8
            figures.Add(new Pawn(new Position(4, 4), 'C')); //2,12
            figures.Add(new Pawn(new Position(3, 6), 'D')); //2,16
            //figures.Add(new Pawn(new Position(1, 1), 'Z'));
            //figures.Add(new Pawn(new Position(2, 2), 'I'));
            figures.Add(new King(new Position(4, 8))); //9, 10            
